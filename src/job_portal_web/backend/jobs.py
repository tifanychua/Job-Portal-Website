...
def browse_jobs(
    ...
    for job in jobs:
        ...
        job_type_count[job_type] = (
            job_type_count.get(job_type, 0) + 1
        )
        ...
        experience_count[experience] = (
            experience_count.get(experience, 0) + 1
        )
    ...
    job_types = [
        ...
        for k, v in job_type_count.items()
    ]
    ...
    experience_levels = [
        ...
        for k, v in experience_count.items()
    ]
